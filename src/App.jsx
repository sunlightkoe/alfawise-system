...
const JOINT_CODES_DB = {
  ...
  "358": { title: "效率能手", pos: "具備核心天賦能級，處事極具效率。", neg: "當能級低位時需注意調整，避免過度耗能。", advice: "建議建立標準化 SOP 流程，對接自動化支付系統。" },
  "382": { title: "應變能手/水火衝", pos: "處理事情積極，能尋求突破。", neg: "脾氣暴躁善變，只對親近的人發脾氣。", advice: "修煉定力，建議投入心靈成長或穩定資源對接。" },
  "821": { title: "銷售冠軍", pos: "極強的銷售能力，不管多大壓力都能承擔。", neg: "內心自卑，不願與人合作，猶豫不決。", advice: "適合帶領衝鋒團隊，對接穩定收款系統。" },
...
const SOURCE_DREAM_REPORT_DB = {
  1: { title: "當領導", motivation: "天生帶領團隊做大事業。", pos: "具備極強領導力與掌控力。", neg: "表現得像老闆，聽不進建議。", action: "管理職、帶領團隊。", sentence: (n) => `「我${n}就是領導人！」` },
  2: { title: "靠嘴征服世界", motivation: "言語具有磁場療癒人心。", pos: "溝通流暢，具有說服力。", neg: "碎碎念、禍從口出。", action: "講師、顧問、銷售。", sentence: (n) => `「我${n}要靠嘴征服世界！」` },
  3: { title: "成為貴族", motivation: "追求精緻與高品質生活。", pos: "氣質優雅，生活有品味。", neg: "虛榮心重，追求外在形式。", action: "奢侈品、藝術創作。", sentence: (n) => `「我${n}會擁有貴族人生！」` },
  ...
  6: { title: "用錢征服世界", motivation: "財富轉化為社會大愛。", pos: "極強的理財能力。", neg: "吝嗇、視財如命。", action: "投資家、慈善基金。", sentence: (n) => `「我${n}要用錢利益眾生！」` },
...
const YEARLY_DETAIL_DB = {
  ...
  2: { core: "溝通合作", career: "合作共富年，請多社交擴展人脈。", negative: "猶豫不決，左右搖擺，需修煉定力。", health: "會表白吸引姻緣，多對另一半說甜蜜情話。" },
  3: { core: "變動磨練", career: "低運年，嚴禁大筆投資。", negative: "容易招小人。", health: "注意心臟。" },
  4: { core: "策劃佈局", career: "投資學習，自我增值。", negative: "鑽牛角尖。", health: "容易失眠。" },
  5: { core: "轉折主動", career: "必須主動出擊，認識貴人。", negative: "固執被動。", health: "擁抱新環境。" },
  6: { core: "財富豐收", career: "財運自來，適合遠瞻投資。", negative: "計較挑剔。", health: "打扮圓融。" },
  7: { core: "貴人幸運", career: "人脈極旺。", negative: "拖延反應慢。", health: "適合結婚。" },
  8: { core: "壓力承擔", career: "不能借錢做保。", negative: "有無力感。", health: "注意體力。" },
  9: { core: "成功結果", career: "成果分享，為新循環準備。", negative: "貪心無度。", health: "注意高壓。" }
};
